...
export const figures: Record<string, Figure> = {
  ...
  player: {
    id: 'player',
    name: '임시정부 서기',
    role: '플레이어 — 임시정부 청사의 젊은 서기(書記)',
    track: 'unity',
    accent: '#d8c9a3',
    outfit: { coat: '#e8e1d2', trim: '#3c4a5a', hat: '#2b3542' },
    inTextbook: false,
    recruitable: false,
    bio: {
      middle:
        '당신이 맡은 인물이에요. 임시정부 청사에서 회의록을 적고 심부름을 다니는 젊은 서기입니다. 실제로 임시정부에는 이런 이름 없는 실무자들이 많았어요.',
      high:
        '플레이어가 맡는 가상의 인물이다. 임시정부 청사에서 문서를 정리하고 연락을 맡은 실무 서기로 설정했다. 특정 실존 인물이 아니며, 기록에 이름이 남지 않은 수많은 실무자를 대표한다.',
    },
    sourceNote:
      '플레이어 캐릭터는 가상 인물이다. 임시정부에 이런 직책의 실무자가 다수 있었다는 사실에 근거해 설정했으나, 특정 개인을 모델로 하지 않았다.',
  },
  ...
  kimgu: {
    ...
    track: 'military',
    accent: '#c9a24b',
    outfit: { coat: '#f2ece0', trim: '#7a6a4a', hat: '#2f2a24' },
    inTextbook: true,
    recruitable: true,
  ...
  leeseungman: {
    ...
    track: 'diplomacy',
    accent: '#7b8fa6',
    outfit: { coat: '#2f3742', trim: '#c8ccd2' },
    inTextbook: true,
    recruitable: true,
  ...
  leedonghwi: {
    ...
    track: 'unity',
    accent: '#8c6f9e',
    outfit: { coat: '#4a4257', trim: '#d6cfe0' },
    inTextbook: true,
    recruitable: true,
  ...
  ahnchangho: {
    ...
    track: 'unity',
    accent: '#5f8f7a',
    outfit: { coat: '#3f5a52', trim: '#e3ded0' },
    inTextbook: true,
    recruitable: true,
  ...
  leedongnyeong: {
    ...
    track: 'unity',
    accent: '#8a8471',
    outfit: { coat: '#efe6d4', trim: '#6b6152', hat: '#39332b' },
    inTextbook: true,
    recruitable: true,
    bonus: { unity: 7 },
    bio: {
  ...
  kimgyusik: {
    ...
    track: 'diplomacy',
    accent: '#4f7fa8',
    outfit: { coat: '#33445c', trim: '#d9e2ea' },
    inTextbook: true,
    recruitable: true,
    bonus: { prestige: 9 },
    bio: {
  ...
  singyusik: {
    ...
    track: 'diplomacy',
    accent: '#6b93a8',
    outfit: { coat: '#3a5160', trim: '#e0e8ec' },
    inTextbook: false,
    recruitable: true,
  ...
  jochoang: {
    ...
    track: 'propaganda',
    accent: '#a8804f',
    outfit: { coat: '#54463a', trim: '#e6d9c2' },
    inTextbook: true,
    recruitable: true,
  ...
  parkchanik: {
    ...
    track: 'diplomacy',
    accent: '#9a7b5a',
    outfit: { coat: '#4c4238', trim: '#ddd2bd' },
    inTextbook: false,
    recruitable: true,
  ...
  yeounhyeong: {
    ...
    track: 'diplomacy',
    accent: '#6f9e8c',
    outfit: { coat: '#3d5c50', trim: '#dfe9e2' },
    inTextbook: true,
    recruitable: true,
  ...
  jeongjeonghwa: {
    ...
    track: 'finance',
    accent: '#c07f8c',
    outfit: { coat: '#f0e6e4', trim: '#8c5f68' },
    inTextbook: false,
    recruitable: true,
  ...
  anheeje: {
    ...
    track: 'finance',
    accent: '#b08946',
    outfit: { coat: '#e9dfc8', trim: '#6e5a34', hat: '#332c22' },
    inTextbook: false,
    recruitable: true,
  ...
  choejaehyeong: {
    ...
    track: 'finance',
    accent: '#7d8b9c',
    outfit: { coat: '#43505f', trim: '#cfd8e0', hat: '#2a323c' },
    inTextbook: false,
    recruitable: true,
  ...
  leesiyeong: {
    ...
    track: 'finance',
    accent: '#8d7f63',
    outfit: { coat: '#ece2cd', trim: '#6a5c44', hat: '#343027' },
    inTextbook: true,
    recruitable: true,
  ...
  eomhangseop: {
    ...
    track: 'propaganda',
    accent: '#a06a5a',
    outfit: { coat: '#4f3c35', trim: '#e6d5c9' },
    inTextbook: false,
    recruitable: true,
  ...
  chariseok: {
    ...
    track: 'propaganda',
    accent: '#8e8574',
    outfit: { coat: '#e7ddc9', trim: '#5f574a' },
    inTextbook: false,
    recruitable: true,
  ...
  parkeunsik: {
    ...
    track: 'propaganda',
    accent: '#9c8f76',
    outfit: { coat: '#f0e8d6', trim: '#635a48', hat: '#38322a' },
    inTextbook: true,
    recruitable: true,
  ...
  sinchaeho: {
    ...
    track: 'unity',
    accent: '#7a6b8a',
    outfit: { coat: '#453d52', trim: '#ddd6e4' },
    inTextbook: true,
    recruitable: true,
  ...
  leegwangsu: {
    ...
    track: 'propaganda',
    accent: '#8a8a8a',
    outfit: { coat: '#5a5a5a', trim: '#d0d0d0' },
    inTextbook: true,
    recruitable: false,
    bio: {
      middle:
  ...
  hwanggihwan: {
    ...
    track: 'diplomacy',
    accent: '#5d84a6',
    outfit: { coat: '#36485c', trim: '#dbe4ec' },
    inTextbook: false,
    recruitable: true,
    bonus: { prestige: 5, agents: 2 },
    bio: {
  ...
  seojaepil: {
    ...
    track: 'propaganda',
    accent: '#7f93a8',
    outfit: { coat: '#3c4754', trim: '#dfe5eb' },
    inTextbook: true,
    recruitable: true,
  ...
  chupucheng: {
    ...
    track: 'diplomacy',
    accent: '#94836a',
    outfit: { coat: '#5a5142', trim: '#ddd3bf' },
    inTextbook: false,
    recruitable: false,
    bio: {
      middle:
  ...
  yunbonggil: {
    ...
    track: 'military',
    accent: '#b5452f',
    outfit: { coat: '#3b4550', trim: '#d8d2c6' },
    inTextbook: true,
    recruitable: true,
  ...
  leebongchang: {
    ...
    track: 'military',
    accent: '#a85a4a',
    outfit: { coat: '#4a4038', trim: '#ded5c4', hat: '#2e2822' },
    inTextbook: true,
    recruitable: true,
  ...
  jicheongcheon: {
    ...
    track: 'military',
    accent: '#8a9a5b',
    outfit: { coat: '#5c6647', trim: '#c8cbb0', hat: '#3d4431' },
    inTextbook: true,
    recruitable: true,
  ...
  ibeomseok: {
    ...
    track: 'military',
    accent: '#a15c3e',
    outfit: { coat: '#5f5340', trim: '#cfc6ad', hat: '#3e3629' },
    inTextbook: true,
    recruitable: true,
    bonus: { forces: 8 },
    bio: {
  ...
  kimwonbong: {
    ...
    track: 'military',
    accent: '#6b7b8c',
    outfit: { coat: '#4b5560', trim: '#c4ccd4', hat: '#333b44' },
    inTextbook: true,
    recruitable: true,
  ...
  kimhakgyu: {
    ...
    track: 'military',
    accent: '#7c8a5f',
    outfit: { coat: '#616b4c', trim: '#ccd0b6', hat: '#414836' },
    inTextbook: false,
    recruitable: true,
  ...
  hanjiseong: {
    ...
    track: 'military',
    accent: '#6e8a8a',
    outfit: { coat: '#4f6a68', trim: '#c2d2d0', hat: '#354646' },
    inTextbook: false,
    recruitable: true,
  ...
  ogwangsim: {
    ...
    track: 'military',
    accent: '#b07f9a',
    outfit: { coat: '#6a5560', trim: '#e2d4dc', hat: '#453640' },
    inTextbook: false,
    recruitable: true,
  ...
  jibokyeong: {
    ...
    track: 'military',
    accent: '#a98ab0',
    outfit: { coat: '#6a5c72', trim: '#e0d6e4' },
    inTextbook: false,
    recruitable: true,
  ...
  bangsunhui: {
    ...
    track: 'unity',
    accent: '#9a7f9e',
    outfit: { coat: '#f0e7ec', trim: '#7a6070' },
    inTextbook: false,
    recruitable: true,
  ...
  jangjunha: {
    ...
    track: 'military',
    accent: '#7b8b6a',
    outfit: { coat: '#5e6a4e', trim: '#ccd2be', hat: '#3f4735' },
    inTextbook: false,
    recruitable: true,
