...
export const timeline: TimelineEntry[] = [
  ...
  { date: '1931-10-01', label: '1931', title: '한인애국단 결성', detail: '존폐 위기의 임시정부를 살리려 김구가 한인애국단을 조직하다.', track: 'military', sourceNote: '김구, 『백범일지』.', prequel: true },
  { date: '1932-01-08', label: '1932. 1. 8.', title: '이봉창 의거', detail: '도쿄에서 일왕을 겨냥한 의거. 실패했지만 세계에 한국 독립운동을 알리다.', track: 'military', sourceNote: '국가보훈부 공훈전자사료관.', prequel: true },
  { date: '1932-04-29', label: '1932. 4. 29.', title: '윤봉길 의거 · 상하이를 떠나다', detail: '훙커우 공원 의거로 중국의 지원을 얻었으나, 일제의 추적을 피해 임시정부가 상하이를 떠나 8년간 이동하다.', track: 'military', sourceNote: '김구, 『백범일지』.', prequel: true },
  ...
  { date: '1941-12-10', label: '1941. 12. 10.', title: '대일 선전 성명', detail: '태평양 전쟁 발발 직후 일본에 선전을 포고하다.', track: 'diplomacy', sourceNote: '발표일은 12월 9일·10일로 달리 소개된다.', prequel: true },
  { date: '1943-11-27', label: '1943. 11.', title: '카이로 선언', detail: '연합국 정상이 「적당한 시기에」 한국을 독립시키기로 결정하다.', track: 'diplomacy', sourceNote: '카이로 선언(1943). 발표 일자 표기는 자료마다 다르다.', prequel: true },
  ...
  { date: '1945-08-10', label: '1945. 8.', title: '국내 진입 작전 무산', detail: 'OSS와 함께 준비한 국내 정진군 작전을 앞두고 일본이 항복하다.', track: 'military', sourceNote: '김구, 『백범일지』.', prequel: true },
