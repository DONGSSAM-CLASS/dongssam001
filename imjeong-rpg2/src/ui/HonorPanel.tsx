...
import { LETTER_MAX, LETTER_MIN, POINTS, canDonate, letterLength, letterProblem } from '../engine/rules';
    ...
    <div className="quest-overlay" role="dialog" aria-label={`${figure.name} 공훈 명패`}>
      <div className="quest-sheet honor-sheet">
        ...
        {tab === 'donate' && !locked && (
          <div className="honor-body">
            <p>
              여행하며 모은 <strong>보훈 포인트</strong>를 {figure.name} 선생님께 드립니다. 기부하면 명패 앞에 흰 국화가 놓여요.
            </p>
        ...
        {tab === 'letter' && !locked && (
          <div className="honor-body">
            ...
            <textarea
              ...
              placeholder={`${figure.name} 선생님께 드리는 편지를 써 보세요. (공백 빼고 ${LETTER_MIN}자 이상)`}
              onChange={(e) => {
