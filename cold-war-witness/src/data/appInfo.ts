...
export const TARGET = {
  ...
  sessions: '6차시 (각 45분) — 디지털 인공지능 윤리 콘텐츠 창작 및 발표 수업의 모든 차시에서 사용',
};
...
export const JUDGING_POINTS = [
  {
    criterion: '윤리원칙 이해',
    how: '「대한민국 인공지능 윤리원칙」 원문(3대 가치·7대 원칙·20개 세부 항목)을 그대로 싣고, 원문의 ‘이용자’ 역할 문장을 근거로 한 14문항 윤리 점검표를 기획(3차시)과 완성(5차시)에 두 번 적용',
  },
  {
    criterion: '교육적 효과성',
    how: '냉전 사건 체험 → 기획 → 창작 → 발표의 6차시 프로젝트, 차시마다 역사 성취기준·내용 요소와 한국형 사회정서교육 성취기준을 연결',
  },
  {
    criterion: '현장 활용성',
    how: '교사가 차시를 열면 학생 화면이 바뀌는 수업 진행, 모둠 현황·기획서 승인·발표 평가·CSV, 6차시 인쇄용 과정안·활동지·가이드',
  },
  { criterion: '창의성', how: '냉전 속 평범한 시민이 되어 보는 역사 의사결정 시뮬레이션을 근거로 모둠이 숏폼·웹툰·카드뉴스·굿즈를 창작' },
  { criterion: '참여성', how: '역할 분담, 모둠 공동 기획서, 동료 검토, 루브릭 상호 평가, AI 활용 기록과 표기, 나의 AI 윤리 실천 선언문' },
];
