...
npm run curriculum:doc   # docs/curriculum-map.md (교육과정 연계표) 다시 만들기
npm run dev         # 뼈대 화면
```
...
- [docs/curriculum-map.md](docs/curriculum-map.md) — 2022 개정 역사과·한국형 사회정서교육 교육과정 연계표 (자동 생성)
...
| 교육과정 원문(성취기준·역량) | `src/data/curriculum.ts` |
